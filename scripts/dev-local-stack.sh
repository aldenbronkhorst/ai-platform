...
export API_KEY
export CONNECTOR_ENDPOINTS_JSON="{\"odoo\":{\"base_url\":\"http://127.0.0.1:$ODOO_PORT\",\"api_key_env\":\"CONNECTOR_INTERNAL_API_KEY\",\"broker_target\":\"odoo\"}}"
export CONNECTOR_INTERNAL_API_KEY="$ODOO_CONNECTOR_API_KEY"
